    ...
    return queryInterface.bulkInsert('Books',
      [
        ...
        },
        {
          ...
          pages: '304',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51lujAx5QmL.jpg',
          description: "REBEKAH PEPPLER is a Paris-based food writer, stylist, and author. She is the author of the James Beard Award-nominated Ap�ritif: Cocktail Hour the French Way and Honey, a Short Stack Edition. She is a regular contributor to the New York Times. Her recipes and food writing appear widely, including in Vanity Fair, Bon App�tit, Real Simple, Food Network, and more. When she's not working, you can find Rebekah cooking, eating, and drinking with friends in the 18th arrondissement.\n" +
            '\n' +
        ...
        },
        {
          ...
          pages: '240',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51WI14sw+zL.jpg',
        ...
        },
        {
          ...
          date_published: new Date('2021-03-23'),
          pages: '400',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51kZaWh3VkL.jpg',
          description: 'Meet the cookbook for bakers, by bakers. This new recipe collection from the brilliant minds behind�Bake from Scratch�magazine is a triumph of dough and batter.',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
        ...
        },
        {
          ...
          pages: '99',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51Pgjbu7Z4L.jpg',
          description: 'With gorgeous photography accompanying each baked good, you�ll find a wealth of visual inspiration and step-by-step tutorials to guide you from beginning to bake. All recipes have been tested and retested with the home baker in mind, formulated to be both accessible and exciting. Celebrate the joy of artisanal baking while you master yeasted breads, layer cakes, cookies and more.',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
        ...
        },
        {
          ...
          date_published: new Date('2021-02-23'),
          pages: '224',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51RrIZpSoBL.jpg',
          description: 'Are you avoiding gluten but yearn for fresh bread, all your favorite takeaways or a naan bread with your curry? And for your sweet tooth do you crave jam doughnuts, bakery-style cookies and classic cakes?',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          pages: '384',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51jPoYkoUcL.jpg',
          description: 'The next cookbook from the #1 New York Times bestselling author behind the Hungry Girl brand!\n' +
            '\n' +
        ...
        },
        {
          ...
          date_published: new Date('2021-04-06'),
          pages: '272',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51UO5i1-DmL.jpg',
          description: 'How to Make Anything Gluten-Free is the first cookbook that shows you how to unlock all the food you truly miss eating � but nothing tastes or looks "gluten-free".',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          pages: '144',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51nBYoYjKaL.jpg',
          description: 'Deadpool brings his inimitable style, foul-mouthed humor, and notorious skill with a blade to the kitchen in this hilarious take on a traditional cookbook, featuring classic recipes with a Deadpool spin and a whole lotta chimichangas.\n' +
            '\n' +
        ...
        },
        {
          ...
          date_published: new Date('2021-01-12'),
          pages: '352',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51lEUuBjUrL.jpg',
          description: "Faigy Murray, a popular recipe developer and food blogger, wants to make sure that this Pesach, your food is spectacular and delicious and you are relaxed and able to enjoy it! In My Pesach Kitchen, she guides you through the process of making, prepping, and cooking for Pesach so it's pressure free for you.",
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          pages: '120',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51EzUI9l-IL.jpg',
        ...
        },
        {
          ...
          date_published: new Date('2021-02-02'),
          pages: '544',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/61eI7Xv6P3L.jpg',
          description: 'Poultry enthusiasts unite!\n' +
        ...
        },
        {
          ...
          pages: '152',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51uFfv5UZwL.jpg',
          description: 'Mary Ellen Phipps is a registered dietitian nutritionist and the founder of Milk & Honey Nutrition�. She lives in Texas with her husband and two daughters.',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          date_published: new Date('2021-03-16'),
          pages: '256',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51YcWMa0pWL.jpg',
          description: 'ALEJANDRO RUIZ is the chef and owner of the Casa Oaxaca restaurants (El Restaurante, Caf� & Restaurante, and the Casa Oaxaca hotel) and Oaxacalifornia, in Oaxaca, Mexico, as well as of Guzina Oaxaca in Mexico City. He is widely known as an ambassador for Oaxacan gastronomy and has represented this celebrated cuisine around the world. He lives in Oaxaca.',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
        ...
        },
        {
          ...
          date_published: new Date('2021-03-23'),
          pages: '176',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51AgBHl4GJL.jpg',
          description: 'Josh Greenberg is the owner of the famous Gates Au Sable Lodge, and writes a popular, on-line fishing report that draws as many as 40,000 hits a month. He has contributed to several magazines, including Fly, Rod & Reel and Fly Fisherman. He is the author of Rivers of Sand: Fly Fishing Michigan and the Great Lakes Region.',
          createdAt: new Date(),
          updatedAt: new Date()
        },
        {
          ...
          date_published: new Date('2021-03-23'),
          pages: '240',
          cover: 'https://images-na.ssl-images-amazon.com/images/I/51Ygxu1peYL.jpg',
          description: 'From the creator of the award-winning food blog, Butter and Brioche, comes a unique and beautifully designed full-color cookbook that brings wild flavors to desserts as told through the seasons. \n' +
            '\n' +
